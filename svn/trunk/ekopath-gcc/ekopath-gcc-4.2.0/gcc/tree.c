    ...
    case tcc_exceptional:
	  ...
	  case INTEGER_CST:
          ...
          case PTRMEM_CST:
	    {
	      ...
	      QUAD_TYPE tmp; // convert long double to QUAD
	      REAL_VALUE_TYPE ld_value = REAL_VALUE_ATOF( string, mode_for_size (LONG_DOUBLE_TYPE_SIZE, MODE_FLOAT, 0) );
	      real_to_target_fmt( (long*)&tmp, &ld_value, &ibm_extended_format );
	      _gs_ld (value_ld, tmp);
#else
