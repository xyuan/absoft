 ...
 */
 		...
 		double _fast_cycles_per_sec = 0.0;
 
 		long long _fast_cycles_max = 0;
 
 		double _nowrap_cycles_per_sec = 0.0;
...
short _init_hw_clock_called = 0;
long long *_rtc_clockaddr = NULL;	/* ptr to 64 bit clock, if any */
int *_rtc_clockaddr32 = NULL;		/* ptr to 32 bit clock, if any */
