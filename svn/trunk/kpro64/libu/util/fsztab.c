...
struct _dsz_s	CDC_SZ = {0};
struct _dsz_s	VAX_SZ;
struct _dsz_s	IEG_SZ;
struct _dsz_s	NVE_SZ = {0};
struct _dsz_s	ETA_SZ = {0};
struct _dsz_s	IEU_SZ = {0};
struct _dsz_s	IED_SZ = {0};
struct _dsz_s	USR_SZ = {0};
struct _dsz_s	STE_SZ = {0};
struct _dsz_s	IBD_SZ = {0};
struct _dsz_s	VAD_SZ = {0};
struct _dsz_s	IUD_SZ = {0};
struct _dsz_s	MIP_SZ;
...
struct _dal_s	CDC_AL = {0};
struct _dal_s	VAX_AL;
struct _dal_s	IEG_AL;
struct _dal_s	NVE_AL = {0};
struct _dal_s	ETA_AL = {0};
struct _dal_s	IEU_AL;
struct _dal_s	IED_AL = {0};
struct _dal_s	USR_AL = {0};
struct _dal_s	STE_AL = {0};
struct _dal_s	IBD_AL = {0};
struct _dal_s	VAD_AL = {0};
struct _dal_s	IUD_AL = {0};
struct _dal_s	MIP_AL;
