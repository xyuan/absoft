...
struct LAYER_DATA _USR0_parse = {0};
struct LAYER_DATA _USR1_parse = {0};
struct LAYER_DATA _USR2_parse = {0};
struct LAYER_DATA _USR3_parse = {0};
struct LAYER_DATA _USR4_parse = {0};
struct LAYER_DATA _USR5_parse = {0};
struct LAYER_DATA _USR6_parse = {0};
struct LAYER_DATA _USR7_parse = {0};
struct LAYER_DATA _USR8_parse = {0};
struct LAYER_DATA _USR9_parse = {0};
