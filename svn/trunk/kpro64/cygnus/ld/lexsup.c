...
static const struct ld_option ld_options[] =
{
  ...
  { {"77", no_argument, NULL, OPTION_F77},
      '\0', NULL, N_("-77 f77 ipa_link"), ONE_DASH },
  { {"90", no_argument, NULL, OPTION_F90},
      '\0', NULL, N_("-90 f90 ipa_link"), ONE_DASH },
  { {"95", no_argument, NULL, OPTION_F95},
      '\0', NULL, N_("-95 f95 ipa_link"), ONE_DASH },
  { {"2k3", no_argument, NULL, OPTION_F2K3},
      '\0', NULL, N_("-23k f2k3 ipa_link"), ONE_DASH },
#endif
};
