...
#ifdef __CYGWIN__
#define CYGWINDLLOUTPUT __declspec(dllexport)

extern CYGWINDLLOUTPUT char* create_tmp_file(char*);

#else
#define CYGWINDLLOUTPUT 
#endif
...
extern CYGWINDLLOUTPUT LD_IPA_OPTION ld_ipa_opt[MAX_LD_IPA];
...
extern CYGWINDLLOUTPUT string tos_string[TOS_MAX];
extern CYGWINDLLOUTPUT string WB_flags;
extern CYGWINDLLOUTPUT string Y_flags;
extern CYGWINDLLOUTPUT string toolroot;
extern CYGWINDLLOUTPUT string tmpdir;
extern CYGWINDLLOUTPUT string outfilename;
extern CYGWINDLLOUTPUT string WB_flags;
extern CYGWINDLLOUTPUT string Y_flags;
extern CYGWINDLLOUTPUT char * __Release_ID;

#if defined(__CYGWIN__) || defined(__APPLE__)
// ABSOFT_EXTENSIONS
extern void *(*p_ipa_open_input)(char *, int *);
#else
...
extern void (*p_process_whirl32)(void *, int, void *, int, const char *);
#else
...
extern CYGWINDLLOUTPUT char *
always_demangle(char *, char );


extern CYGWINDLLOUTPUT void read_one_section(int , void *);

extern CYGWINDLLOUTPUT void 
...
extern CYGWINDLLOUTPUT string
concat_names(const string, const string);

extern CYGWINDLLOUTPUT int
do_compile (string *);
...
extern CYGWINDLLOUTPUT unsigned long long
