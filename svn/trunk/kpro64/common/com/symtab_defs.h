...
enum ST_FLAGS_EXT
{
    ...
    , ST_IS_GLOBAL = 		  0x10
    , ST_IS_INITIALIZED_IN_FILE = 0x20
    , ST_IS_STDCALL      =  0x00000040
    , ST_IS_INTRINSIC    =  0x00000080
    , ST_IS_FUNCTION_CRI_POINTEE = 0x00000100
    , ST_IS_INITIALIZED_IN_F90 =   0x00000200
    , ST_IS_BEEN_LOCALIZED = 0x00000400 // Used in opt_sym.cxx
#endif
}; // ST_FLAGS_EXT
#endif
...
#if 1
    // defined(ABSOFT_EXTENSIONS)
    mUINT32 flags_ext;			// more attributes
    mUINT8  flags_res;			// fill alignment gap
#else
...
#ifdef ABSOFT_EXTENSIONS
#define PU_HAS_SPECIALABI       0x0000100000000000LL  // PU use special ABI
#endif
