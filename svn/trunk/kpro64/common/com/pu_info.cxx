...
PU_Info_init (PU_Info *pu)
{
    ...
    Set_PU_Info_tree_ptr(pu, NULL );
    Set_PU_Info_symtab_ptr( pu, NULL );
    Set_PU_Info_depgraph_ptr( pu, NULL );
    Set_PU_Info_regions_ptr( pu, NULL );
    Set_PU_Info_feedback_ptr( pu, NULL );
    Set_PU_Info_frequencies_ptr( pu, NULL );
    Set_PU_Info_alias_class_ptr( pu, NULL );
    Set_PU_Info_ac_internal_ptr( pu, NULL );
#endif
}
