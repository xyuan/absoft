...
#ifdef _KEEP_RCS_ID
/*REFERENCED*/
static char *config_lno_h_rcs_id = "$Source$ $Revision: 2935 $";
#endif /* _KEEP_RCS_ID */
...
#ifdef ABSOFT_EXTENSIONS
#define LNO_Simd_Stride			Current_LNO->Simd_Stride
#define LNO_Fusion_Max_Size		Current_LNO->Fusion_max_size
#endif
...
#endif /* KEY */
#define LNO_Lno_Verbose                 Current_LNO->Lno_Verbose
