...
Is_Valid_Opcode_Parts (OPERATOR opr, TYPE_ID rtype, TYPE_ID desc)
{
  BOOL valid;
	...
	valid  = valid || ((rtype == MTYPE_V16I1 && desc == MTYPE_V16I1) || 
			  ...
			  (rtype == MTYPE_V16F4 && desc == MTYPE_V16F4) || 
			  (rtype == MTYPE_V16F8 && desc == MTYPE_V16F8) ||
			  (rtype == MTYPE_V8I1 && desc == MTYPE_V8I1) || 
			  (rtype == MTYPE_V8I2 && desc == MTYPE_V8I2) || 
			  (rtype == MTYPE_V8I4 && desc == MTYPE_V8I4) || 
			  (rtype == MTYPE_V8F4 && desc == MTYPE_V8F4) || 
			  (rtype == MTYPE_V16C4 && desc == MTYPE_V16C4) ||
			  (rtype == MTYPE_V16C8 && desc == MTYPE_V16C8));
#endif /* TARG_X8664 */
        break;
	...
	break;
      ...
      case OPR_ROUND:
	valid = ((desc == MTYPE_F4 && rtype == MTYPE_F4) ||
		 (desc == MTYPE_F8 && rtype == MTYPE_F8) ||
		 (desc == MTYPE_V16F4 && rtype == MTYPE_V16F4) ||
		 (desc == MTYPE_V16F8 && rtype == MTYPE_V16F8) );
	break;
#endif
      default:
        valid = FALSE;
