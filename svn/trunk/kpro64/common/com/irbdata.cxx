...
INITV_Init_Integer (INITV_IDX inv, TYPE_ID mtype, INT64 val, UINT64 repeat)
#else
...
void
#ifdef ABSOFT_EXTENSIONS
INITV_Init_Float (INITV_IDX inv, TYPE_ID mtype, double val, UINT64 repeat)
#else
...
void
#ifdef ABSOFT_EXTENSIONS
INITV_Init_String (INITV_IDX inv, char *str, INT size, UINT64 repeat)
#else
