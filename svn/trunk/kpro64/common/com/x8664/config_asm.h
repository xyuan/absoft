 ...
 * Module: config_asm.h
 * $Revision: 2492 $
 * $Date: 2006-11-10 09:40:07 -0500 (Fri, 10 Nov 2006) $
 * $Author: yin $
 * $Source$
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *config_asm_rcs_id = "$Source$ $Revision: 2492 $";
#endif /* _KEEP_RCS_ID */
...
#define BSS_RAW_NAME		".zerofill __DATA"
#else
...
#define AS_DATA_SECTION "__DATA,__data"
#define AS_TEXT_SECTION "__TEXT,__text"
#define AS_RODATA_SECTION "__DATA,__rodata"
#define AS_TEXT_SEG "__TEXT,"
#define AS_TEXT_SECT "__text"
#define AS_DATA_SEG "__DATA,"
#define AS_DATA_SECT "__data"
#define AS_RODATA_SECT "__const"
#define AS_BSS_SECTION  ".zerofill __DATA,"
#define AS_ZEROFILL ".zerofill"
#define AS_RODATA "__rodata"
#else
...
#define AS_FILL		".fill"
#define AS_REPEAT	".rept"
#define AS_REPEATEND	".endr"
#endif
