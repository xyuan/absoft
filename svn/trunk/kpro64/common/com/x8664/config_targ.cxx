 ...
 * $Revision: 3051 $
 * $Date: 2009-06-25 12:43:55 -0400 (Thu, 25 Jun 2009) $
 * $Author: yin $
 * $Source$
 *
 *
...
Prepare_Target ( void )
{
  ...
  if( Target_ABI == ABI_n32 ){
      // [YIN2005-12-16] [JIRA BE-120]
      int x87_mask;
      switch ( Target_x87_Precision ) {
		case 32:  x87_mask = 0x07f; break;	// single precision
		case 64:  x87_mask = 0x27f; break;	// double precision
		case 80:  x87_mask = 0x37f; break;	// double-extended precision
		default:  FmtAssert(FALSE,
				("Prepare_Target: invalid x87 precision"));
      }      
      _FPU_SETCW( x87_mask );
  }
#endif
