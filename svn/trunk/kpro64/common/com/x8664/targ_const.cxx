 ...
 * Module: targ_const.c
 * $Revision: 2915 $
 * $Date: 2008-10-03 16:27:31 -0400 (Fri, 03 Oct 2008) $
 * $Author: yin $
 * $Source$
 *
 * Revision history:
...
#endif
#if defined(ABSOFT_EXTENSIONS)
	qmag = RQ_To_R16(__c_q_sqrt(__c_q_add(
			  __c_q_mul(R16_To_RQ(qi),R16_To_RQ(qi),&err),
			  __c_q_mul(R16_To_RQ(qr),R16_To_RQ(qr),&err),
			  &err), &err) );
	if (__c_q_eq(R16_To_RQ(qmag), R16_To_RQ(q0), &err))
	{
		rqr = q0;
		rqi = q0;
	}
	else if (__c_q_gt(R16_To_RQ(qr), R16_To_RQ(q0), &err)) {
		rqr = RQ_To_R16(__c_q_sqrt(__c_q_mul(R16_To_RQ(q05), __c_q_add(R16_To_RQ(qmag), R16_To_RQ(qr), &err), &err), &err));
		rqi = RQ_To_R16(__c_q_mul(R16_To_RQ(q05), __c_q_div(R16_To_RQ(qi), R16_To_RQ(rqr), &err), &err));
	}
	else
	{
		rqi = RQ_To_R16(__c_q_sqrt(__c_q_mul(R16_To_RQ(q05), __c_q_sub(R16_To_RQ(qmag), R16_To_RQ(qr), &err), &err), &err));
		if (__c_q_lt(R16_To_RQ(qi), R16_To_RQ(q0), &err)) rqi =	RQ_To_R16(__c_q_neg(R16_To_RQ(rqi),&err));
		rqr = RQ_To_R16(__c_q_mul(R16_To_RQ(q05), __c_q_div(R16_To_RQ(qi),R16_To_RQ(rqi),&err),&err));
	}
#else
...
static TCON complex_divide(TCON c0, TCON c1)
{
   ...
   switch (TCON_ty(c0)) {
	...
	Zero_Quad(q0);
	 ...
	 ai = c1i;
#if defined(ABSOFT_EXTENSIONS)
	if ( __c_q_lt(R16_To_RQ(ar), R16_To_RQ(q0), &err))
	  ar = RQ_To_R16(__c_q_neg(R16_To_RQ(ar), &err));
	if ( __c_q_lt(R16_To_RQ(ai), R16_To_RQ(q0), &err))
	  ai = RQ_To_R16(__c_q_neg(R16_To_RQ(ai), &err));
	if ( __c_q_lt(R16_To_RQ(ar), R16_To_RQ(ai), &err)) {
		t4 = RQ_To_R16(__c_q_div(R16_To_RQ(c1r), R16_To_RQ(c1i), &err));
		t2 = RQ_To_R16(__c_q_add(R16_To_RQ(c1i), __c_q_mul(R16_To_RQ(c1r),R16_To_RQ(t4),&err), &err));
		t1 = RQ_To_R16(__c_q_div(__c_q_sub(__c_q_mul(R16_To_RQ(c0i),R16_To_RQ(t4),&err),R16_To_RQ(c0r),&err),R16_To_RQ(t2),&err));
		t3 = RQ_To_R16(__c_q_div(__c_q_add(__c_q_mul(R16_To_RQ(c0r),R16_To_RQ(t4),&err), R16_To_RQ(c0i), &err), R16_To_RQ(t2),&err));
	} else {
		t4 = RQ_To_R16(__c_q_div(R16_To_RQ(c1i),R16_To_RQ(c1r),&err));
		t2 = RQ_To_R16(__c_q_add(R16_To_RQ(c1r),__c_q_mul(R16_To_RQ(c1i),R16_To_RQ(t4),&err),&err));
		t1 = RQ_To_R16(__c_q_div(__c_q_sub(R16_To_RQ(c0i), __c_q_mul(R16_To_RQ(c0r),R16_To_RQ(t4),&err), &err), R16_To_RQ(t2), &err));
		t2 = RQ_To_R16(__c_q_div(__c_q_add(__c_q_mul(R16_To_RQ(c0i),R16_To_RQ(t4),&err), R16_To_RQ(c0r), &err), R16_To_RQ(t2), &err));
	}
#else
	 if ( ar < q0 ) ar = -ar;
	 if ( ai < q0 ) ai = -ai;
   ...
   *folded = TRUE;
   ...
   if (DEBUG_Trap_Uv && MTYPE_float(optype) && MTYPE_float(desc) &&
     ...
     case MTYPE_FQ:
       ...
       switch (opr) {
#if defined(ABSOFT_EXTENSIONS)
	 case OPR_EQ: TCON_v0(c0) = __c_q_eq(R16_To_RQ(TCON_R16(c0)), R16_To_RQ(TCON_R16(c1)),&err); break;
	 case OPR_NE: TCON_v0(c0) = __c_q_ne(R16_To_RQ(TCON_R16(c0)), R16_To_RQ(TCON_R16(c1)),&err); break;
	 case OPR_LT: TCON_v0(c0) = __c_q_lt(R16_To_RQ(TCON_R16(c0)), R16_To_RQ(TCON_R16(c1)),&err) ? 1 : 0; break;
	 case OPR_LE: TCON_v0(c0) = __c_q_le(R16_To_RQ(TCON_R16(c0)), R16_To_RQ(TCON_R16(c1)),&err) ? 1 : 0; break;
	 case OPR_GT: TCON_v0(c0) = __c_q_gt(R16_To_RQ(TCON_R16(c0)), R16_To_RQ(TCON_R16(c1)),&err) ? 1 : 0; break;
	 case OPR_GE: TCON_v0(c0) = __c_q_ge(R16_To_RQ(TCON_R16(c0)), R16_To_RQ(TCON_R16(c1)),&err) ? 1 : 0; break;
#else
    ...
    */
	...
	if (__c_q_ge(R16_To_RQ(TCON_R16(c0)),R16_To_RQ(zero),&err)) {
		TCON_R16(c0) = RQ_To_R16(__c_q_flotj((INT32)(__c_ki_qint(__c_q_add(R16_To_RQ(TCON_R16(c0)),R16_To_RQ(q05),&err),&err)),&err));
	} else {
		TCON_R16(c0) = RQ_To_R16(__c_q_flotj((INT32)(__c_ki_qint(__c_q_sub(R16_To_RQ(TCON_R16(c0)),R16_To_RQ(q05),&err),&err)),&err));
	}
#else
    if (TCON_R16(c0) >= 0.0){
	...
	Zero_Quad(q05);
	q05.hi = 0.5;
	if (__c_q_ge(R16_To_RQ(TCON_R16(c0)), R16_To_RQ(zero64), &err)) {
		TCON_R16(c0) = RQ_To_R16(__c_q_flotk((INT64)(__c_ki_qint(__c_q_add(R16_To_RQ(TCON_R16(c0)),R16_To_RQ(q05),&err),&err)),&err));
	} else {
		TCON_R16(c0) = RQ_To_R16(__c_q_flotk((INT64)(__c_ki_qint(__c_q_sub(R16_To_RQ(TCON_R16(c0)),R16_To_RQ(q05),&err),&err)),&err));
	}
#else
    if (TCON_R16(c0) >= 0.0 ){
    ...
    case OPC_U4FQRND:
       ...
       Zero_Quad(q05);
       q05.hi = 0.5;
       TCON_R16(c0) = RQ_To_R16(__c_q_flotj((UINT32)__c_ki_qint(__c_q_add(R16_To_RQ(TCON_R16(c0)), R16_To_RQ(q05), &err), &err), &err));
#else
    ...
    case OPC_U8FQRND:
#if defined(ABSOFT_EXTENSIONS)
       TCON_R16(c0) = RQ_To_R16(__c_q_flotk((UINT64)__c_ki_qint(__c_q_add(R16_To_RQ(TCON_R16(c0)), R16_To_RQ(q05), &err), &err), &err));
#else
    ...
    case OPC_FQABS:
#if defined(ABSOFT_EXTENSIONS)
	QUAD_TYPE zero3; Zero_Quad(zero3);
        if (__c_q_lt(R16_To_RQ(TCON_R16(c0)), R16_To_RQ(zero3), &err))
	  TCON_R16(c0) = RQ_To_R16(__c_q_neg(R16_To_RQ(TCON_R16(c0)), &err));
#else
...
#if defined(ABSOFT_EXTENSIONS)
	TCON_R16(c0) = RQ_To_R16(__c_q_neg(R16_To_RQ(TCON_R16(c0)), &err));
	TCON_IR16(c0) = RQ_To_R16(__c_q_neg(R16_To_RQ(TCON_IR16(c0)), &err));
#else
    TCON_R16(c0) = -TCON_R16(c0);
    ...
    case OPC_CQADD:
#if defined(ABSOFT_EXTENSIONS)
	TCON_R16(c0) = RQ_To_R16(__c_q_add(R16_To_RQ(TCON_R16(c0)), R16_To_RQ(TCON_R16(c1)), &err));
	TCON_IR16(c0) = RQ_To_R16(__c_q_add(R16_To_RQ(TCON_IR16(c0)), R16_To_RQ(TCON_IR16(c1)), &err));
#else
    TCON_R16(c0) += TCON_R16(c1);
	...
	*folded = FALSE;
    ...
    case OPC_CQMPY:
#if defined(ABSOFT_EXTENSIONS)
          QUAD qc0, qc1, qic0, qic1;
	  qc0 = R16_To_RQ(TCON_R16(c0));
	  qc1 = R16_To_RQ(TCON_R16(c1));
	  qic0 = R16_To_RQ(TCON_IR16(c0));
	  qic1 = R16_To_RQ(TCON_IR16(c1));
	  TCON_R16(t1) = RQ_To_R16(__c_q_sub(__c_q_mul(qc0,qc1, &err), __c_q_mul(qic0,qic1, &err), &err));
	  TCON_IR16(c0) = RQ_To_R16(__c_q_add(__c_q_mul(qc0,qic1, &err), __c_q_mul(qic0,qc1, &err), &err));
...
/*	 ErrMsg( EC_Ill_UModulus );*/
	*folded = FALSE;
    ...
    case OPC_FQRECIP:
      ...
      Zero_Quad(q10);
      q10.hi = 1.0;
      c0 = Targ_WhirlOp(OPC_FQDIV,Host_To_Targ_Quad(RQ_To_R16(__c_q_add(R16_To_RQ(qzero),R16_To_RQ(q10), &err))),c0,folded);
#else
    ...
    case OPC_FQRSQRT:
      ...
      Zero_Quad(q10);
      q10.hi = 1.0;
      if (*folded) c0 = Targ_WhirlOp(OPC_FQDIV,Host_To_Targ_Quad(RQ_To_R16(__c_q_add(R16_To_RQ(qzero),R16_To_RQ(q10), &err))),c0,folded);
#else
...
#if defined(ABSOFT_EXTENSIONS)
      TCON_R4(r) = TCON_R16HI(c);
      TCON_IR4(r) = TCON_IR16HI(c);
#else
...
#if defined(ABSOFT_EXTENSIONS)
      TCON_U8(r) = (UINT64)__c_ki_qint(R16_To_RQ(TCON_R16(c)), &err);
#else
...
#if defined(ABSOFT_EXTENSIONS)
      TCON_U8(r) = (UINT64)__c_ki_quint(R16_To_RQ(TCON_R16(c)), &err);
#else
      TCON_U8(r) = (UINT64)TCON_R16(c);
#endif
      break;
...
#if defined(ABSOFT_EXTENSIONS)
      TCON_u0(r) = (UINT32)__c_ji_quint(R16_To_RQ(TCON_R16(c)), &err);
#else
...
#define TPB_SIZE 8
   ...
   case MTYPE_FQ:
	...
	char r1[1024];
	int err;
	__c_q_to_a(r1, R16_To_RQ(TCON_R16(c)), &err);
	sprintf(r,"%s", r1);
	break;
#else
	...
	*re = 'd';
    ...
    case MTYPE_CQ:
	 ...
	 char r2[1024];
	__c_q_to_a(r1, R16_To_RQ(TCON_R16(c)), &err);
	__c_q_to_a(r2, R16_To_RQ(TCON_IR16(c)), &err);
	sprintf(r, "%s, %s",r1,r2);
#else
...
static TCON Targ_Ipower(TCON base, UINT64 exp, BOOL neg_exp, BOOL *folded, TYPE_ID btype)
{
   ...
   *folded = TRUE;
   ...
   TCON_ty(r) = btype;
#if defined(ABSOFT_EXTENSIONS)
   QUAD_TYPE qzero; Zero_Quad(qzero);
#endif
...
#define RAD_TO_DEGQ (180.0l/M_PIL)
   ...
   switch ((INTRINSIC) intrinsic) {
    ...
    case INTRN_F4EXP:
#ifdef ABSOFT_EXTENSIONS
      TCON_R4(c0) = promoted_expf(TCON_R4(c0));
#else
    ...
    case INTRN_F8EXP:
#ifdef ABSOFT_EXTENSIONS
      TCON_R8(c0) = promoted_exp(TCON_R8(c0));
#else
    ...
    case INTRN_F4LOG:
#ifdef ABSOFT_EXTENSIONS
      TCON_R4(c0) = promoted_logf(TCON_R4(c0));
#else
    ...
    case INTRN_F8LOG:
#ifdef ABSOFT_EXTENSIONS
      TCON_R8(c0) = promoted_log(TCON_R8(c0));
#else
    ...
    case INTRN_F4LOG10:
#ifdef ABSOFT_EXTENSIONS
      TCON_R4(c0) = promoted_log10f(TCON_R4(c0));
#else
    ...
    case INTRN_F8LOG10:
#ifdef ABSOFT_EXTENSIONS
      TCON_R8(c0) = promoted_log10(TCON_R8(c0));
#else
    ...
    case INTRN_F4ACOS:
#ifdef ABSOFT_EXTENSIONS
      TCON_R4(c0) = promoted_acosf(TCON_R4(c0));
#else
    ...
    case INTRN_F8ACOS:
#ifdef ABSOFT_EXTENSIONS
      TCON_R8(c0) = promoted_acos(TCON_R8(c0));
#else
    ...
    case INTRN_F4ASIN:
#ifdef ABSOFT_EXTENSIONS
      TCON_R4(c0) = promoted_asinf(TCON_R4(c0));
#else
    ...
    case INTRN_F8ASIN:
#ifdef ABSOFT_EXTENSIONS
      TCON_R8(c0) = promoted_asin(TCON_R8(c0));
#else
    ...
    case INTRN_F4ACOSD:
#ifdef ABSOFT_EXTENSIONS
      TCON_R4(c0) = RAD_TO_DEG*promoted_acosf(TCON_R4(c0));
#else
    ...
    case INTRN_F8ACOSD:
#ifdef ABSOFT_EXTENSIONS
      TCON_R8(c0) = RAD_TO_DEG*promoted_acos(TCON_R8(c0));
#else
    ...
    case INTRN_F4ASIND:
#ifdef ABSOFT_EXTENSIONS
      TCON_R4(c0) = RAD_TO_DEG*promoted_asinf(TCON_R4(c0));
#else
    ...
    case INTRN_F8ASIND:
#ifdef ABSOFT_EXTENSIONS
      TCON_R8(c0) = RAD_TO_DEG*promoted_asin(TCON_R8(c0));
#else
    ...
    case INTRN_F4COSH:
#ifdef ABSOFT_EXTENSIONS
      TCON_R4(c0) = promoted_coshf(TCON_R4(c0));
#else
    ...
    case INTRN_F8COSH:
#ifdef ABSOFT_EXTENSIONS
      TCON_R8(c0) = promoted_cosh(TCON_R8(c0));
#else
    ...
    case INTRN_F4SINH:
#ifdef ABSOFT_EXTENSIONS
      TCON_R4(c0) = promoted_sinhf(TCON_R4(c0));
#else
    ...
    case INTRN_F8SINH:
#ifdef ABSOFT_EXTENSIONS
      TCON_R8(c0) = promoted_sinh(TCON_R8(c0));
#else
    ...
    case INTRN_F4TANH:
#ifdef ABSOFT_EXTENSIONS
      TCON_R4(c0) = promoted_tanhf(TCON_R4(c0));
#else
    ...
    case INTRN_F8TANH:
#ifdef ABSOFT_EXTENSIONS
      TCON_R8(c0) = promoted_tanh(TCON_R8(c0));
#else
