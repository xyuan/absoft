 ...
 * Module: defs.h
 * $Revision: 2681 $
 * $Date: 2007-04-19 13:00:32 -0400 (Thu, 19 Apr 2007) $
 * $Author: yin $
 * $Source$
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *defs_rcs_id = "$Source$ $Revision: 2681 $";
#endif /* _KEEP_RCS_ID */
 ...
 */
#if (defined(_COMPILER_VERSION) && (_COMPILER_VERSION >= 400) && _SGIAPI) || defined(__GNUC__) && !defined(ABSOFT_EXTENSIONS)
