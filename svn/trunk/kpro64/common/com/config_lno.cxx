...
#ifdef _KEEP_RCS_ID
/*REFERENCED*/
static char *config_lno_rcs_id = "$Source$ $Revision: 2935 $";
#endif /* _KEEP_RCS_ID */
...
#endif /* KEY */ 
  LNOPT_BOOL ( "verbose",               NULL,    Lno_Verbose), 
...
#endif
#ifdef ABSOFT_EXTENSIONS 
  LNOPT_BOOL ( "simd_stride",	NULL,	Simd_Stride ),
   /* 0, no limit - 1, level > 1 will not be fused */
  LNOPT_U32  ( "fusion_max_size",	NULL,	0,0,99999,
					Fusion_max_size ),  
#endif
...
#ifdef ABSOFT_EXTENSIONS
  /* This is for fusion, don't fuse large loop in order to decrease register pressure */
  if( Is_Target_32bit() ){
      if( LNO_Fusion_Max_Size == 0 ) LNO_Fusion_Max_Size = 512;
  }
#endif	
