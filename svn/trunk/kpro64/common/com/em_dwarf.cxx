...
void
Em_Dwarf_Start_Label_Line( Dwarf_Unsigned label_idx, USRCPOS usrcpos )
{
  
    dwarf_lne_set_address (dw_dbg, 0, label_idx, &dw_error);  
    dwarf_add_line_entry(dw_dbg, 
			file_table[USRCPOS_filenum(usrcpos)].dwarf_idx, 
			0, 
			USRCPOS_linenum(usrcpos), 
...
void
Em_Dwarf_Last_Label_Line( Dwarf_Unsigned label_idx )
{
    dwarf_lne_set_address (dw_dbg, 0, label_idx, &dw_error);  
}
#endif
