 ...
 * Module: irbdata.h
 * $Revision: 949 $
 * $Date: 2005-12-14 09:39:28 -0500 (Wed, 14 Dec 2005) $
 * $Author: yin $
 * $Source$
 *
 * Revision history:
...
#ifdef ABSOFT_EXTENSIONS
	TYPE_ID mtype, INT64 val, UINT64 repeat = 1);
#else
...
extern void
#ifdef ABSOFT_EXTENSIONS
INITV_Init_Float (INITV_IDX inv, TYPE_ID mtype, double val, UINT64 repeat =1 );
#else
...
extern void
#ifdef ABSOFT_EXTENSIONS
INITV_Init_String (INITV_IDX inv, char *str, INT size, UINT64 repeat = 1);
#else
...
inline void
#ifdef ABSOFT_EXTENSIONS
INITV_Set_int (INITV& initv, INITVKIND kind, TYPE_ID m, UINT64 rp2) {
#else
...
inline void
#ifdef ABSOFT_EXTENSIONS
INITV_Set_ZERO (INITV& initv, TYPE_ID m, UINT64 rp2) {
#else
...
inline void
#ifdef ABSOFT_EXTENSIONS
INITV_Set_ONE (INITV& initv, TYPE_ID m, UINT64 rp2) {
#else
...
inline void
#ifdef ABSOFT_EXTENSIONS
INITV_Set_VAL (INITV& initv, TCON_IDX t, mUINT64 rp2) {
#else
...
extern INITV_IDX
#ifdef ABSOFT_EXTENSIONS
Irb_Init_Val (INITO_IDX ino, INITV_IDX inv, UINT64 repeat, TCON_IDX tc);
#else
...
extern INITV_IDX
#ifdef ABSOFT_EXTENSIONS
Irb_Init_Integer (INT size, INT64 value, INT64 repeat, INITO_IDX ino,
#else
...
extern INITV_IDX
#ifdef ABSOFT_EXTENSIONS
Irb_Init_Integer_Of_Type (TYPE_ID mtype, INT64 value, INT64 repeat,
#else
...
extern INITV_IDX
#ifdef ABSOFT_EXTENSIONS
Irb_Init_String (INT size, char *str, INT64 repeat, INITO_IDX ino,
#else
