 ...
 * $Revision: 3037 $
 * $Date: 2009-06-02 15:44:29 -0400 (Tue, 02 Jun 2009) $
 * $Author: yin $
 * $Source$
 *
 * Revision history:
...
BOOL  WOPT_Enable_Load_PRE_Set = FALSE;
BOOL  WOPT_Enable_Load_PRE = FALSE;
#else
...
#ifdef ABSOFT_EXTENSIONS
BOOL  WOPT_Enable_Simple_If_Conv = FALSE;   /* simple if-conversion at CFG build time */
#else
...
#ifdef ABSOFT_EXTENSIONS
// [YIN2005-11-30] [JIRA BE-105]
BOOL  WOPT_Enable_Store_PRE_Set = FALSE;
BOOL  WOPT_Enable_Store_PRE = FALSE;
#else
...
#ifdef ABSOFT_EXTENSIONS
// [YIN2005-11-4] [JIRA BE-70]
BOOL  WOPT_Enable_Iload_Prop_Set = FALSE;
BOOL  WOPT_Enable_Iload_Prop = FALSE;
#else
...
#ifdef ABSOFT_EXTENSIONS
BOOL WOPT_Enable_Strong_MP_Barrier = FALSE; /* enable strong barrier for open_mp barrier */
BOOL WOPT_Enable_Strong_MP_Barrier_Set = FALSE; 
BOOL WOPT_Enable_Loose_MP_Equivalent = FALSE; /* make localized sym become equivalent during opt */
BOOL WOPT_Enable_Loose_MP_Equivalent_Set = FALSE;
BOOL WOPT_Enable_MPPragma_Need_MU = TRUE; /* generate MU for certain openmp pragma node */
BOOL WOPT_Enable_MPPragma_Need_MU_Set = FALSE;
BOOL WOPT_Enable_MPPragma_Need_CHI = TRUE; /* generate CHI for certain openmp pragma node */
BOOL WOPT_Enable_MPPragma_Need_CHI_Set = FALSE;
#endif
...
static OPTION_DESC Options_WOPT[] = {
  ...
  { OVK_BOOL,	OV_VISIBLE,	TRUE, "lpre",			"lpre",
    0, 0, 0,	&WOPT_Enable_Load_PRE, &WOPT_Enable_Load_PRE_Set },
#else
  { OVK_BOOL,	OV_VISIBLE,	TRUE, "lpre",			"lpre",
  ...
  { OVK_BOOL,	OV_VISIBLE,	TRUE, "spre",			"spre",
    0, 0, 0,	&WOPT_Enable_Store_PRE, &WOPT_Enable_Store_PRE_Set },
#else
  { OVK_BOOL,	OV_VISIBLE,	TRUE, "spre",			"spre",
  ...
  { OVK_BOOL,	OV_VISIBLE,	TRUE, "iload_prop",		"iload",
    0, 0, 0,	&WOPT_Enable_Iload_Prop, &WOPT_Enable_Iload_Prop_Set },
#else
  { OVK_BOOL,	OV_VISIBLE,	TRUE, "iload_prop",		"iload",
...
#ifdef ABSOFT_EXTENSIONS
  { OVK_BOOL,	OV_VISIBLE,	TRUE, "strong_mp_barrier",		"",
    0, 0, 0,	&WOPT_Enable_Strong_MP_Barrier, &WOPT_Enable_Strong_MP_Barrier_Set },
  { OVK_BOOL,	OV_VISIBLE,	TRUE, "loose_mp_equiv",		"",
    0, 0, 0,	&WOPT_Enable_Loose_MP_Equivalent, &WOPT_Enable_Loose_MP_Equivalent_Set },
  { OVK_BOOL,	OV_VISIBLE,	TRUE, "mppragma_need_mu",		"",
    0, 0, 0,	&WOPT_Enable_MPPragma_Need_MU, &WOPT_Enable_MPPragma_Need_MU_Set },
  { OVK_BOOL,	OV_VISIBLE,	TRUE, "mppragma_need_chi",		"",
    0, 0, 0,	&WOPT_Enable_MPPragma_Need_CHI, &WOPT_Enable_MPPragma_Need_CHI_Set },
#endif
