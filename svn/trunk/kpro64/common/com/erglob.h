 ...
 * Module: erglob.h
 * $Revision: 2883 $
 * $Date: 2008-08-15 13:44:19 -0400 (Fri, 15 Aug 2008) $
 * $Author: yin $
 * $Source$
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *erglob_rcs_id = "$Source$ $Revision: 2883 $";
#endif /* _KEEP_RCS_ID */
...
#define EC_Windows_Stack_Not_Enough EC_Undef_Code+342       /* int64, int64 */
#define EC_Windows_Stack_May_Not_Enough EC_Undef_Code+343   /* int64 */
#endif
