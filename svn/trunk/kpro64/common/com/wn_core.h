...
public:
   union {
	...
	union {
	    UINT32 	    vector_index; /* iload, istore, 0 is uninitialized */
	} uc;
#endif
      } uu;
      WN_ESIZE	    element_size;
...
#ifdef ABSOFT_EXTENSIONS
#define WN_vector_index(x)	((x)->u1u2.uu.uc.vector_index)
#endif
...
#ifdef ABSOFT_EXTENSIONS
#define WN_CALL_RETURN_LOWERED  0x2000  /* marked for openmp to prevent redundent first fake parm for 32bit */
#endif
...
#ifdef ABSOFT_EXTENSIONS
#define WN_Call_Return_Lowered(x)	(WN_call_flag(x) & WN_CALL_RETURN_LOWERED)
#define WN_Set_Call_Return_Lowered(x)	(WN_call_flag(x) |= WN_CALL_RETURN_LOWERED)
#define WN_Reset_Call_Return_Loweredp(x) (WN_call_flag(x) &= ~WN_CALL_RETURN_LOWERED)
#endif
