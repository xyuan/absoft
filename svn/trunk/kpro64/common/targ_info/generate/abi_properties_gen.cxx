...
//
//  $Revision: 2818 $
//  $Date: 2008-01-21 11:37:57 -0500 (Mon, 21 Jan 2008) $
//  $Author: yin $
//  $Source$
...
/////////////////////////////////////
{
  ...
  //
#ifdef __CYGWIN__
  fprintf(hfile, "\nextern const char *ABI_PROPERTY_Reg_Name(\n"
		 "  ISA_REGISTER_CLASS rc,\n"
		 "  INT reg);\n");
  fprintf(cfile, "\nconst char *ABI_PROPERTY_Reg_Name(\n"
		 "  ISA_REGISTER_CLASS rc,\n"
  ...
  for (prop_iter = props.begin(); prop_iter != props.end(); ++prop_iter) {
    ...
    if (prop->is_reg) {
...
#ifdef __CYGWIN__
      fprintf( hfile, 
      "\nextern BOOL ABI_PROPERTY_Is_%s(\n"
		     "  ISA_REGISTER_CLASS rc,\n"
		     "  INT reg);\n",
		     prop->name);
      ...
      fprintf(
      hfile, 
      "inline BOOL ABI_PROPERTY_Is_%s(\n"
		     "  ISA_REGISTER_CLASS rc,\n"
		     "  INT reg)\n"
		     "{\n",
		     prop->name);
