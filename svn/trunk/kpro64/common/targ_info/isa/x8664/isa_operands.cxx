...
//
//  $Revision: 2934 $
//  $Date: 2008-11-13 14:34:09 -0500 (Thu, 13 Nov 2008) $
//  $Author: yin $
//  $Source$
...
int main()
{
  ...
  const OPERAND_VALUE_TYPE fp32 =
    ISA_Reg_Opnd_Type_Create("fp32", ISA_REGISTER_CLASS_float,
			     ISA_REGISTER_SUBCLASS_UNDEFINED,
			     32, SIGNED, INVALID);
#endif
...
#ifdef ABSOFT_EXTENSIONS
  Instruction_Group("vector arithmetic with immediate",
			   TOP_mpsadbw,
		    	   TOP_blendps,
		    	   TOP_blendpd,
		    	   TOP_blendvps,
...
#ifdef ABSOFT_EXTENSIONS
  // [YIN2005-11-10] [JIRA BE-79] [JIRA BE-87] [JIRA BE-93]
  Instruction_Group("fp 2 fp double",
		    TOP_movsd,
		    TOP_cvtss2sd,
		    TOP_UNDEFINED);
  Result(0, fp64);
  ...
  Instruction_Group("fp 2 fp single",
		    TOP_movss,
		    TOP_cvtsd2ss,
		    TOP_UNDEFINED);
  Result(0, fp32);
...
#ifdef ABSOFT_EXTENSIONS
  Instruction_Group("int32 2 float double ",
  		    TOP_movg2x,
		    TOP_cvtsi2sd,
		    TOP_UNDEFINED);
  Result(0, fp64);
  ...
  Instruction_Group("int32 2 float single",
		    TOP_cvtsi2ss,
		    TOP_UNDEFINED);
  Result(0, fp32);
  Operand(0, int32, opnd1);
...
#ifdef ABSOFT_EXTENSIONS
  Instruction_Group("int64 2 float double",
	  	    TOP_movg2x64,
		    TOP_cvtsi2sdq,
		    TOP_UNDEFINED);
  Result(0, fp64);
  ...
  Instruction_Group("int64 2 float single",
		    TOP_cvtsi2ssq,
		    TOP_UNDEFINED);
  Result(0, fp32);
  Operand(0, int64, opnd1);
...
#ifdef ABSOFT_EXTENSIONS
  Instruction_Group("sign64 extend in same register",
		    TOP_cltq,
		    TOP_UNDEFINED);
  Result(0, rax);
  Operand(0, rax, opnd1);
  
  Instruction_Group("add the offset of two labels into a register",
                     TOP_addlofst32,
		     TOP_UNDEFINED);
  Result(0, int32);
  Operand(0, pcrel32, offset);
  Operand(1, pcrel32, scale);
...
#ifdef ABSOFT_EXTENSIONS
  Instruction_Group("float nt_load w/o base or index double",
		    TOP_movntdqa_n64,
		    TOP_UNDEFINED);
  Result(0, fp128);
  Operand(0, simm64, offset);

  Instruction_Group("float load w/o base or index double",
		    TOP_ldsd_n32,
		    TOP_UNDEFINED);
  Result(0, fp64);
  Operand(0, simm32, offset);

  Instruction_Group("float load w/o base or index single",
		    TOP_ldss_n32,
		    TOP_UNDEFINED);
  Result(0, fp32);
  Operand(0, simm32, offset);
...
#ifdef ABSOFT_EXTENSIONS
  Instruction_Group("float load double",
		    TOP_ldsd,
		    TOP_UNDEFINED);
  Result(0, fp64);
  Operand(0, int64, base);
  ...
  Instruction_Group("float load single",
		    TOP_ldss,
		    TOP_UNDEFINED);
  Result(0, fp32);
  Operand(0, int64, base);
...
#ifdef ABSOFT_EXTENSIONS
  Instruction_Group("float convert double",
		    TOP_cvtsi2sd_x,
		    TOP_cvtsi2sdq_x,
		    TOP_UNDEFINED);
  Result(0, fp64);
  ...
  Instruction_Group("float convert single",
		    TOP_cvtsd2ss_x,
		    TOP_cvtsi2ss_x,
		    TOP_cvtsi2ssq_x,
		    TOP_UNDEFINED);
...
#ifdef ABSOFT_EXTENSIONS
  Instruction_Group("x87 control-word load imm32",
		    TOP_fldcw_n32,
		    TOP_UNDEFINED);
  Result(0, x87_cw);
  Operand(0, simm32, offset);
  
  Instruction_Group("x87 status-word store ax",
		    TOP_fnstsw,
		    TOP_UNDEFINED);
  Result(0, ax);
  Operand(0, x87_cw, storeval);   

  Instruction_Group("store ah into flags",
		    TOP_sahf,
		    TOP_UNDEFINED);
  Result(0,  eflags);
  Operand(0, ax, storeval);  
...
#ifdef ABSOFT_EXTENSIONS
  Instruction_Group("float store double",
		    TOP_stsd,
		    TOP_stntsd,
		    TOP_UNDEFINED);
  Operand(0, fp64, storeval);
  ...
  Instruction_Group("float store single",
		    TOP_stss,
		    TOP_stntss,
		    TOP_UNDEFINED);
  Operand(0, fp32, storeval);
...
#ifdef ABSOFT_EXTENSIONS
  Instruction_Group("float arithmetic double",
		    TOP_andnpd,
		    TOP_addsd,
		    TOP_divsd,
		    TOP_subsd,
  ...
  Instruction_Group("float arithmetic single",
		    TOP_andnps,
		    TOP_addss,
		    TOP_divss,
		    TOP_subss,
...
#ifdef ABSOFT_EXTENSIONS
  Instruction_Group("x87 float fprem",
	            TOP_fprem,	    
		    TOP_UNDEFINED);
  Result( 0, x87 );
  Result( 1, x87_cw); // Use x87_cw as x87_sw
  Operand(0, x87, opnd1);
  Operand(1, x87, opnd2);

  Instruction_Group("float arithmetic mem operand double",
		    TOP_divxsd,
		    TOP_addxsd,
		    TOP_subxsd,
		    TOP_mulxsd,
  ...
  Instruction_Group("float arithmetic mem operand single",
		    TOP_divxss,
		    TOP_addxss,
		    TOP_subxss,
		    TOP_mulxss,
...
#ifdef ABSOFT_EXTENSIONS
  Instruction_Group("float arithmetic mem operand w/ scaled-index double",
		    TOP_divxxsd,
		    TOP_addxxsd,
		    TOP_subxxsd,
		    TOP_mulxxsd,
  ...
  Instruction_Group("float arithmetic mem operand w/ scaled-index single",
		    TOP_divxxss,
		    TOP_addxxss,
		    TOP_subxxss,
		    TOP_mulxxss,
...
#ifdef ABSOFT_EXTENSIONS
  Instruction_Group("float arithmetic mem operand w/ scaled-index w/o base double",
		    TOP_divxxxsd,
		    TOP_addxxxsd,
		    TOP_subxxxsd,
		    TOP_mulxxxsd,
  ...
  Instruction_Group("float arithmetic mem operand w/ scaled-index w/o base single",
		    TOP_divxxxss,
		    TOP_addxxxss,
		    TOP_subxxxss,
		    TOP_mulxxxss,
...
#ifdef ABSOFT_EXTENSIONS
  Instruction_Group("float unary arithmetic double",
		    TOP_sqrtsd,
		    TOP_UNDEFINED);
  Result(0, fp64);
  Operand(0, fp64, opnd1);

  Instruction_Group("float unary arithmetic single",
		    TOP_sqrtss,
		    TOP_rsqrtss,
		    TOP_rcpss,
		    TOP_UNDEFINED);
...
#ifdef ABSOFT_EXTENSIONS
  Instruction_Group("fp compare double",
		    TOP_cmpsd,
		    TOP_UNDEFINED);
  Result(0, fp64);
  Operand(0, fp64,  opnd1);
  ...
  Instruction_Group("fp compare single",
		    TOP_cmpss,
		    TOP_UNDEFINED);
  Result(0, fp32);
  Operand(0, fp64,  opnd1);
...
#ifdef ABSOFT_EXTENSIONS
  Instruction_Group("fp compare I single",
		    TOP_cmpeqss,
		    TOP_cmpltss,
		    TOP_cmpless,
		    TOP_cmpunordss,
  ...
  Instruction_Group("load32 effective addr by using label offset",
		    TOP_leapic32,
		    TOP_UNDEFINED);
  Result(0, int32);
  Operand(0, simm32, offset);
  ...
  Instruction_Group("load64 effective addr by using label offset",
		    TOP_leapic64,
		    TOP_UNDEFINED);
  Result(0, int64);
  Operand(0, simm32, offset); 
  Operand(1, pcrel32, offset);
...
#ifdef ABSOFT_EXTENSIONS
  Instruction_Group("fp load w/ indx double",
		    TOP_ldsdx,
		    TOP_UNDEFINED);
  Result(0,  fp64);
  Operand(0, int64, base);
  ...
  Instruction_Group("fp load w/ indx single",
		    TOP_ldssx,
		    TOP_UNDEFINED);
  Result(0,  fp32);
  Operand(0, int64, base);
...
#ifdef ABSOFT_EXTENSIONS
  Instruction_Group("fp convert w/ indx double",
		    TOP_cvtsi2sd_xx,
		    TOP_cvtsi2sdq_xx,
		    TOP_UNDEFINED);
  Result(0,  fp64);
  ...
  Instruction_Group("fp convert w/ indx single",
		    TOP_cvtsd2ss_xx,
		    TOP_cvtsi2ss_xx,
		    TOP_cvtsi2ssq_xx,
		    TOP_UNDEFINED);
...
#ifdef ABSOFT_EXTENSIONS
  Instruction_Group("fp load w/ indx w/o base double",
		    TOP_ldsdxx,
		    TOP_UNDEFINED);
  Result(0,  fp64);
  Operand(0, int64, index);
  ...
  Instruction_Group("fp load w/ indx w/o base single",
		    TOP_ldssxx,
		    TOP_UNDEFINED);
  Result(0,  fp32);
  Operand(0, int64, index);
...
#ifdef ABSOFT_EXTENSIONS
  Instruction_Group("fp convert w/ indx w/o base double",
		    TOP_cvtsi2sd_xxx,
		    TOP_cvtsi2sdq_xxx,
		    TOP_UNDEFINED);
  Result(0,  fp64);
  ...
  Instruction_Group("fp convert w/ indx w/o base single",
		    TOP_cvtsd2ss_xxx,
		    TOP_cvtsi2ss_xxx,
		    TOP_cvtsi2ssq_xxx,
		    TOP_UNDEFINED);
...
#ifdef ABSOFT_EXTENSIONS
  Instruction_Group("fp store w/ indx double",
		    TOP_stsdx,
		    TOP_stntsdx,
		    TOP_UNDEFINED);
  Operand(0, fp64, storeval);
  ...
  Instruction_Group("fp store w/ indx single",
		    TOP_stssx,
		    TOP_stntssx,
		    TOP_UNDEFINED);
  Operand(0, fp32, storeval);
...
#ifdef ABSOFT_EXTENSIONS
  Instruction_Group("fp store w/ indx w/o base double",
		    TOP_stsdxx,
		    TOP_stntsdxx,
		    TOP_UNDEFINED);
  Operand(0, fp64, storeval);
  ...
  Instruction_Group("fp store w/ indx w/o base single",
		    TOP_stssxx,
		    TOP_stntssxx,
		    TOP_UNDEFINED);
  Operand(0, fp32, storeval);
...
#ifdef ABSOFT_EXTENSIONS
  Instruction_Group("xzero double",
		    TOP_xzero64,
		    TOP_UNDEFINED);
  Result(0, fp64);

  Instruction_Group("xzero single",
		    TOP_xzero32,
		    TOP_UNDEFINED);
  Result(0, fp64);
#else
...
#ifdef ABSOFT_EXTENSIONS  
  Instruction_Group("SSE4.1 insert memory",
		    TOP_insertps,
		    TOP_pinsrb,
		    TOP_pinsrw2,
		    TOP_pinsrd,
  ...
  Instruction_Group("SSE4.1 insert memory w/o base",
	            TOP_insertps_n32,	
	            TOP_pinsrb_n32,	
	            TOP_pinsrw_n32,	
	            TOP_pinsrd_n32,	
  ...
  Instruction_Group("SSE4.1 insert memory with index",
		    TOP_insertpsx,
		    TOP_pinsrbx,
		    TOP_pinsrwx,
		    TOP_pinsrdx,
  ...
  Instruction_Group("SSE4.1 insert memory with index w/o base",
		    TOP_insertpsxx,
		    TOP_pinsrbxx,
		    TOP_pinsrwxx,
		    TOP_pinsrdxx,
  ...
  Instruction_Group("SSE4.1 extract memory",
		    TOP_extractps,
		    TOP_pextrb,
		    TOP_pextrw2,
		    TOP_pextrd,
  ...
  Instruction_Group("SSE4.1 extract memory w/o base",
		    TOP_extractps_n32,
	            TOP_pextrb_n32,	
	      	    TOP_pextrw_n32,	
	            TOP_pextrd_n32,	
  ...
  Instruction_Group("SSE4.1 extract memory with index",
		    TOP_extractpsx,
		    TOP_pextrbx,
		    TOP_pextrwx,
		    TOP_pextrdx,
  ...
  Instruction_Group("SSE4.1 extract memory with index w/o base",
		    TOP_extractpsxx,
		    TOP_pextrbxx,
		    TOP_pextrwxx,
		    TOP_pextrdxx,
