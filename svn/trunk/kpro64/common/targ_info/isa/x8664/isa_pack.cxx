...
#ifdef ABSOFT_EXTENSIONS
		    TOP_leas32,	0x000000ff,
		    TOP_leas64,	0x000000ff,
		    TOP_leapic32, 	0x000000ff,
		    TOP_leapic64,	0x000000ff,
#endif
...
#ifdef ABSOFT_EXTENSIONS
		    TOP_fldcw_n32,    0x000000ff,
		    TOP_fprem,	  0x000000ff,
		    TOP_fnstsw,   0x000000ff,
		    TOP_sahf,     0x000000ff, 
/* SSE4.1 Instructions */
		    ...
		    TOP_pminsw,		0x000000ff,
		    TOP_pmaxsw,		0x000000ff,
		    ...
		    TOP_movntdqax,	0x000000ff,
		    TOP_movntdqaxx,	0x000000ff,	
		    TOP_movntdqa_n64,	0x000000ff,
		    ...
		    TOP_pextrqxx,	0x000000ff,
	            TOP_pinsrw2,	0x000000ff,
	            TOP_pextrw2,	0x000000ff,
    	            TOP_extractps_n32,	0x000000ff,
	            TOP_insertps_n32,	0x000000ff,
	            TOP_pinsrb_n32,	0x000000ff,
	            TOP_pinsrw_n32,	0x000000ff,
	            TOP_pinsrd_n32,	0x000000ff,
	            TOP_pinsrq_n32,	0x000000ff,
	            TOP_pextrb_n32,	0x000000ff,
	      	    TOP_pextrw_n32,	0x000000ff,
	            TOP_pextrd_n32,	0x000000ff,
	      	    TOP_pextrq_n32,  	0x000000ff,	    	   
#endif
