 ...
 */
MEM_POOL MEM_local_pool = {0};
MEM_POOL MEM_src_pool = {0};
MEM_POOL MEM_pu_pool = {0};
MEM_POOL MEM_phase_pool = {0};
 ...
 * appropriate.
 */
MEM_POOL MEM_local_nz_pool = {0};
MEM_POOL MEM_src_nz_pool = {0};
MEM_POOL MEM_pu_nz_pool = {0};
MEM_POOL MEM_phase_nz_pool = {0};
...
#if (defined(linux) && !__APPLE__ )|| defined(MEM_STATS)
  MEM_POOL *pool;
