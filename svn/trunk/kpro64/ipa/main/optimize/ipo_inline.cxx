...
Array_reshape_eq (WN* actual, TREE_ITER& iter)
{
    ...
    if( WN_element_size( wn ) != WN_element_size( array_node ) ){
	DevWarn( "Inlined formal array has different element size!! Please check the frondend. Use the nearest one now." );
	WN_element_size( array_node ) = WN_element_size( wn );
    }
#endif
