...
CDIR$ NAME (SGEMVX="_SGEMVX")
      SUBROUTINE SGEMVX( M, N, ALPHA, A, INCCA, INCRA, X, INCX,
     $                   BETA, Y, INCY )
!DIR$ ID "@(#) libfi/matrix/sgemvx.f	92.0	"
!DIR$ ID "10/08/98 14:37:14"
*     ENTRY SGEMVX_( M, N, ALPHA, A, INCCA, INCRA, X, INCX, BETA,
*    $               Y, INCY )
*
...
*  =======
*
*  SGEMVX performs the matrix-vector multiplication
*
*     y := alpha*A*x + beta*y,
*
