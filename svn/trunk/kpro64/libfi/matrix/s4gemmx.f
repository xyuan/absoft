...
CDIR$ NAME (S4GEMMX="_S4GEMMX")
      SUBROUTINE S4GEMMX( M, N, K, ALPHA, A, INCCA, INCRA, B, INCCB,
     $                   INCRB, BETA, C, INCCC, INCRC )
!DIR$ ID "@(#) libfi/matrix/s4gemmx.f	92.0	"
!DIR$ ID "10/08/98 14:37:14"
*     ENTRY  S4GEMMX_( M, N, K, ALPHA, A, INCCA, INCRA, B, INCCB,
*    $                 INCRB, BETA, C, INCCC, INCRC )
*
...
*
*     .. Scalar Arguments ..
      INTEGER  INCCA, INCCB, INCCC, INCRA, INCRB, INCRC, K, M, N
...
*  =======
*
*  S4GEMMX performs the matrix-matrix operation
*
*     C := alpha*A*B + beta*C,
*
