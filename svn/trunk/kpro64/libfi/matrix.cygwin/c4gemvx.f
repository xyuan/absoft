...
CDIR$ NAME (C4GEMVX="_C4GEMVX")
      SUBROUTINE C4GEMVX( ICONJ, M, N, ALPHA, A, INCCA, INCRA, X, INCX,
     $                   BETA, Y, INCY )
!DIR$ ID "@(#) libfi/matrix/c4gemvx.f	92.0	"
!DIR$ ID "10/08/98 14:37:14"
*     ENTRY C4GEMVX_( ICONJ, M, N, ALPHA, A, INCCA, INCRA, X, INCX,
*    $                   BETA, Y, INCY )
*
...
*  =======
*
*  C4GEMVX performs the matrix-vector multiplication
*
