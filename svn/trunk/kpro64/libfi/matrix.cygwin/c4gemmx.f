...
CDIR$ NAME (C4GEMMX="_C4GEMMX")
      SUBROUTINE C4GEMMX( ICONJA, ICONJB, M, N, K, ALPHA, A, INCCA,
     $                   INCRA, B, INCCB, INCRB, BETA, C, INCCC, INCRC )
!DIR$ ID "@(#) libfi/matrix/c4gemmx.f	92.0	"
!DIR$ ID "10/08/98 14:37:14"
*     Remove this entry when the -e U option is working for cf90.
*     ENTRY C4GEMMX_( ICONJA, ICONJB, M, N, K, ALPHA, A, INCCA,
*    $                   INCRA, B, INCCB, INCRB, BETA, C, INCCC, INCRC )
*
...
*  =======
*
*  C4GEMMX performs the matrix-matrix operation
*
*     C := alpha*A*B + beta*C,
*
...
*
*     .. Parameters ..
      COMPLEX(KIND=4)           ONE, ZERO
C     COMPLEX*8                 ONE, ZERO
