...
extern void Expand_Float_Vector_Compares( OPCODE compare,TN *dest, TN *src1, TN *src2, TYPE_ID mtype, OPS *ops);
extern void Expand_Convert_Vector_Length ( TN *dest, TN *src, TYPE_ID rtype, TYPE_ID desc, OPS *ops );
#endif
...
#ifdef ABSOFT_EXTENSIONS
extern void Expand_Dot (OPCODE opcode, TN *result, TN *src1, TN *src2, VARIANT variant, OPS *ops);
extern void Expand_Round (OPCODE opcode, TN *result, TN *src1, VARIANT variant, OPS *ops);
extern void Expand_Mod_Float (TN *result, TN *src1, TN *src2, TYPE_ID mtype, OPS *ops);
extern void Expand_Indexed_Load ( TYPE_ID mtype, TN *result, TN *base, TN *disp, TN* index_tn, OPS *ops);
extern void Expand_Indexed_Store (TYPE_ID mtype, TN *obj_tn, TN *base_tn, TN* disp_tn, TN* index_tn, OPS *ops );  
#endif
