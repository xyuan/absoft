...
#ifdef TARG_X64
extern BOOL EMIT_stack_probe;
extern INT32 CG_memory_page_size; 
#endif

#ifdef ABSOFT_EXTENSIONS
extern BOOL CG_x87_fxch_remove;
extern BOOL CG_x87_sse2_partition;
extern BOOL CG_x87_temp_remove;
#endif
