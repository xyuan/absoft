...
static OPTION_DESC Options_CG_SWP[] = {
  ...
  { OVK_BOOL,	OV_INTERNAL,	TRUE, "while_loop", NULL,
    0, 0, 0,	&SWP_Options.Enable_While_Loop, &SWP_Options.Enable_While_Loop_Set },
...
static OPTION_DESC Options_CG[] = {
...
#ifdef TARG_X64
  { OVK_BOOL,	OV_INTERNAL, TRUE,"emit_stack_probe", "",
    0, 0, 0, &EMIT_stack_probe, NULL },
#endif
#ifdef KEY
  ...
  { OVK_BOOL,	OV_INTERNAL, TRUE,  "x87_partition", "",
    0,0,0,      &CG_x87_sse2_partition, NULL, 
    "convert some instructions to x87 instruction to remove fxch insertion"
  },
  { OVK_BOOL,	OV_INTERNAL, TRUE,  "remove_x87_temp", "",
    0,0,0,      &CG_x87_temp_remove, NULL, 
    "convert remove some x87 temp load/store pair by replacing sse2 to x87 instrustion"
  },
#endif
#ifdef TARG_X8664
...
#ifdef ABSOFT_EXTENSIONS
	/* OSX tempnam return tmp.XXXX, which makes New_Extension fail */
	Obj_File_Name = Append_Extension( tmp_fname, OBJ_FILE_EXTENSION );
#else
