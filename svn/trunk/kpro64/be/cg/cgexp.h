...
/* create select for float vector noncondition statement */
extern void Exp_Select_Float_Vector_Noncondition ( 
        OPCODE select, TN *result, TN* cond, TN *true_tn, TN *false_tn, OPS *ops );
#ifdef TARG_X64
/* insert __chkstk call */
extern void Exp_Chkstk( INT64 size, TN* size_tn, OPS* ops, BOOL afterLRA );
#endif
...
#ifdef ABSOFT_EXTENSIONS
/* the optimization controls of expand.cxx and exp.cxx */
extern BOOL x87_Control_Fixed;    
