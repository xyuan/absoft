 ...
 *  Module: cg_flags.c
 *  $Revision: 2920 $
 *  $Date: 2008-10-09 12:23:36 -0400 (Thu, 09 Oct 2008) $
 *  $Author: yin $
...
#ifdef TARG_X64
BOOL EMIT_stack_probe = TRUE;
INT32 CG_memory_page_size = 4096; 
#endif

#ifdef ABSOFT_EXTENSIONS
BOOL CG_x87_fxch_remove = TRUE;
BOOL CG_x87_sse2_partition = TRUE;
BOOL CG_x87_temp_remove = TRUE;
#endif
