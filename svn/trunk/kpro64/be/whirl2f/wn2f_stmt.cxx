 ...
 * Module: wn2f_stmt.c
 * $Revision: 1980 $
 * $Date: 2006-03-31 11:30:24 -0500 (Fri, 31 Mar 2006) $
 * $Author: bjh $
 * $Source$
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
/*REFERENCED*/
static char *rcs_id = "$Source$ $Revision: 1980 $";
#endif
...
WN2F_return(TOKEN_BUFFER tokens, WN *wn, WN2F_CONTEXT context)
{
   ...
   if (PU_is_mainpu(Get_Current_PU()) || 
       ...
       strcmp(ST_name(WN_entry_name(PUinfo_current_func)), "_MAIN__") == 0 ||
       strcmp(ST_name(WN_entry_name(PUinfo_current_func)), "main") == 0 || 
#endif
