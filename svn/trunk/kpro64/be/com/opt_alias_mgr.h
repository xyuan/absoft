...
#ifdef _KEEP_RCS_ID
static char *opt_alias_mgrrcs_id = 	opt_alias_mgr_INCLUDED"$Revision: 258 $";
#endif /* _KEEP_RCS_ID */
...
#ifdef __CYGWIN__
extern "C" ALIAS_MANAGER *Create_Alias_Manager(MEM_POOL *pu_pool);
extern "C" void Delete_Alias_Manager(ALIAS_MANAGER *am, MEM_POOL *pu_pool);
extern "C" void Create_Restricted_Map(MEM_POOL *pu_pool);
extern "C" void Delete_Restricted_Map(void);
#endif
