...
typedef enum {
  ...
  FIOSTRUCT_FIRST = 1,
    ...
    FCR_OPEN_CONVERT = 148,
    FCR_OPEN_BLOCKSIZE = 149,
    FCR_OPEN_CARRIAGECONTROL = 150,
    FCR_OPEN_MAXREC = 151,
    FCR_OPEN_BUFFER = 152,
    FCR_OPEN_DISPOSE = 153,
    FCR_OPEN_BLOCK = 154,
#if defined(TARG_X64) || defined(__APPLE__)
    FCR_OPEN_CREATOR = 155,
    FCR_OPEN_FILETYPE = 156,
#define WINDOWS_ITEMS 2
#else
#define WINDOWS_ITEMS 0
#endif



   /* Cray close descriptor fields */
    FCR_CLOSE_VERSION = 155 + WINDOWS_ITEMS,
    FCR_CLOSE_UNIT = 156 + WINDOWS_ITEMS,
    FCR_CLOSE_IOSTAT = 157 + WINDOWS_ITEMS,
    FCR_CLOSE_ERR = 158 + WINDOWS_ITEMS,
    FCR_CLOSE_STATUS = 159 + WINDOWS_ITEMS,

   /* Cray Inquire descriptor fields */
    FCR_INQ_VERSION = 160 + WINDOWS_ITEMS,
    FCR_INQ_UNIT = 161 + WINDOWS_ITEMS,
    FCR_INQ_FILE = 162 + WINDOWS_ITEMS,
    FCR_INQ_IOSTAT = 163 + WINDOWS_ITEMS,
    FCR_INQ_ERR = 164 + WINDOWS_ITEMS,
    FCR_INQ_EXIST = 165 + WINDOWS_ITEMS,
    FCR_INQ_OPENED = 166 + WINDOWS_ITEMS,
    FCR_INQ_NUMBER = 167 + WINDOWS_ITEMS,
    FCR_INQ_NAMED = 168 + WINDOWS_ITEMS,
    FCR_INQ_NAME = 169 + WINDOWS_ITEMS,
    FCR_INQ_ACCESS = 170 + WINDOWS_ITEMS,
    FCR_INQ_SEQUENTIAL = 171 + WINDOWS_ITEMS,
    FCR_INQ_DIRECT = 172 + WINDOWS_ITEMS,
    FCR_INQ_FORM = 173 + WINDOWS_ITEMS,
    FCR_INQ_FORMATTED = 174 + WINDOWS_ITEMS,
    FCR_INQ_UNFORMATTED = 175 + WINDOWS_ITEMS,
    FCR_INQ_RECL = 176 + WINDOWS_ITEMS,
    FCR_INQ_NEXTREC = 177 + WINDOWS_ITEMS,
    FCR_INQ_BLANK = 178 + WINDOWS_ITEMS,
    FCR_INQ_POSITION = 179 + WINDOWS_ITEMS,
    FCR_INQ_ACTION = 180 + WINDOWS_ITEMS,
    FCR_INQ_READ = 181 + WINDOWS_ITEMS,
    FCR_INQ_WRITE = 182 + WINDOWS_ITEMS,
    FCR_INQ_READWRITE = 183 + WINDOWS_ITEMS,
    FCR_INQ_DELIM = 184 + WINDOWS_ITEMS,
    FCR_INQ_PAD = 185 + WINDOWS_ITEMS,

    FCR_INQ_BLOCKSIZE = 186 + WINDOWS_ITEMS,
    FCR_INQ_CARRIAGECONTROL = 187 + WINDOWS_ITEMS,
    FCR_INQ_FLEN = 188 + WINDOWS_ITEMS,
    FCR_INQ_SIZE = 189 + WINDOWS_ITEMS,

    /* Cray Dope Vector descriptor fields */
    FCR_DV_BASE_PTR = 190 + WINDOWS_ITEMS,
    FCR_DV_BASE_LEN = 191 + WINDOWS_ITEMS,
    FCR_DV_FLAG_INFO = 192 + WINDOWS_ITEMS,
    FCR_DV_TYPE_LEN = 193 + WINDOWS_ITEMS,
    FCR_DV_ORIG_BASE = 194 + WINDOWS_ITEMS,
    FCR_DV_ORIG_SIZE = 195 + WINDOWS_ITEMS,
    FCR_DV_DIM1_LB = 196 + WINDOWS_ITEMS,
    FCR_DV_DIM1_EXTENT = 197 + WINDOWS_ITEMS,
    FCR_DV_DIM1_STRIDE = 198 + WINDOWS_ITEMS,
    FCR_DV_DIM2_LB = 199 + WINDOWS_ITEMS,
    FCR_DV_DIM2_EXTENT = 200 + WINDOWS_ITEMS,
    FCR_DV_DIM2_STRIDE = 201 + WINDOWS_ITEMS,
    FCR_DV_DIM3_LB = 202 + WINDOWS_ITEMS,
    FCR_DV_DIM3_EXTENT = 203 + WINDOWS_ITEMS,
    FCR_DV_DIM3_STRIDE = 204 + WINDOWS_ITEMS,
    FCR_DV_DIM4_LB = 205 + WINDOWS_ITEMS,
    FCR_DV_DIM4_EXTENT = 206 + WINDOWS_ITEMS,
    FCR_DV_DIM4_STRIDE = 207 + WINDOWS_ITEMS,
    FCR_DV_DIM5_LB = 208 + WINDOWS_ITEMS,
    FCR_DV_DIM5_EXTENT = 209 + WINDOWS_ITEMS,
    FCR_DV_DIM5_STRIDE = 210 + WINDOWS_ITEMS,
    FCR_DV_DIM6_LB = 211 + WINDOWS_ITEMS,
    FCR_DV_DIM6_EXTENT = 212 + WINDOWS_ITEMS,
    FCR_DV_DIM6_STRIDE = 213 + WINDOWS_ITEMS,
    FCR_DV_DIM7_LB = 214 + WINDOWS_ITEMS,
    FCR_DV_DIM7_EXTENT = 215 + WINDOWS_ITEMS,
    FCR_DV_DIM7_STRIDE = 216 + WINDOWS_ITEMS,

       /* FID_IOSCALAR_ENTRY */
    FCR_IOSCALAR_ENTRY = 217 + WINDOWS_ITEMS,
    FCR_IOSCALAR_TYPE_T = 218 + WINDOWS_ITEMS,
    FCR_IOSCALAR_ADDR = 219 + WINDOWS_ITEMS,
    FCR_IOSCALAR_CHAR_LEN = 220 + WINDOWS_ITEMS,

      /* FID_IOARRAY_ENTRY */
    FCR_IOARRAY_ENTRY = 221 + WINDOWS_ITEMS,
    FCR_IOARRAY_DV_ADDR = 222 + WINDOWS_ITEMS,
    FCR_IOARRAY_FLAG = 223 + WINDOWS_ITEMS,
    FCR_IOARRAY_IDX1 = 224 + WINDOWS_ITEMS,
    FCR_IOARRAY_IDX2 = 225 + WINDOWS_ITEMS,
    FCR_IOARRAY_IDX3 = 226 + WINDOWS_ITEMS,
    FCR_IOARRAY_IDX4 = 227 + WINDOWS_ITEMS,
    FCR_IOARRAY_IDX5 = 228 + WINDOWS_ITEMS,
    FCR_IOARRAY_IDX6= 229 + WINDOWS_ITEMS,
    FCR_IOARRAY_IDX7 = 230 + WINDOWS_ITEMS,

    /* FID_IOIMPLIEDDO_ENTRY */
    FCR_IOIMPLIEDDO_ENTRY = 231 + WINDOWS_ITEMS,
    FCR_IOIMPLIEDDO_VAR_ADDR = 232 + WINDOWS_ITEMS,
    FCR_IOIMPLIEDDO_BEGIN_CNT = 233 + WINDOWS_ITEMS,
    FCR_IOIMPLIEDDO_END_CNT = 234 + WINDOWS_ITEMS,
    FCR_IOIMPLIEDDO_INC_CNT = 235 + WINDOWS_ITEMS,

    FIOSTRUCT_LAST = 235 + WINDOWS_ITEMS
#else
...
#ifdef ABSOFT_EXTENSIONS
#if defined(TARG_X64) || defined(__APPLE__)
	FCR_OPEN_VERSION, FCR_OPEN_BLOCK, 132+16, 264+32,  ".cray_open_desc", ".cray_open_desc_ptr",
						"_cray_open_desc", /* FID_CRAY_OPENLIST */
#else
	FCR_OPEN_VERSION, FCR_OPEN_BLOCK, 132, 264,  ".cray_open_desc", ".cray_open_desc_ptr",
						"_cray_open_desc", /* FID_CRAY_OPENLIST */
#endif
#else
...
#ifdef ABSOFT_EXTENSIONS
   FCR_INQ_VERSION, FCR_INQ_PAD,   192, 376,    ".cray_inq_desc",  ".cray_inq_desc_ptr",
...
static FIOSTRUCT_INFO fiostruct_info [FIOSTRUCT_LAST + 1] = {
    ...
    208,  MTYPE_I4,    408,  MTYPE_I4,    FID_INLIST,	"inwritelen",
     ...
     44, MTYPE_U4,      80, MTYPE_U8,     FID_CRAY_CLIST, "cray_ci_size",
      ...
      0, MTYPE_U4,	0, MTYPE_U8,      FID_CRAY_OPENLIST, "cray_open_version",
							/* FCR_OPEN_VERSION */
      4, MTYPE_U4,	8, MTYPE_U8,      FID_CRAY_OPENLIST, "cray_open_unit",
							/* FCR_OPEN_UNIT */
      8, MTYPE_U4,     16, MTYPE_U8,      FID_CRAY_OPENLIST, "cray_open_iostat",
							/* FCR_OPEN_IOSTAT */
     12, MTYPE_U4,     24, MTYPE_U8,      FID_CRAY_OPENLIST, "cray_open_err",
							/* FCR_OPEN_ERR */
     16, MTYPE_M,      32, MTYPE_M,       FID_CRAY_OPENLIST, "cray_open_file",
							/* FCR_OPEN_FILE */
     24, MTYPE_M,      48, MTYPE_M,       FID_CRAY_OPENLIST, "cray_open_status",
							/* FCR_OPEN_STATUS */
     32, MTYPE_M,      64, MTYPE_M,       FID_CRAY_OPENLIST, "cray_open_access",
							/* FCR_OPEN_ACCESS */
     40, MTYPE_M,      80, MTYPE_M,       FID_CRAY_OPENLIST, "cray_open_form",
							/* FCR_OPEN_FORM */
     48, MTYPE_U4,     96, MTYPE_U8,      FID_CRAY_OPENLIST, "cray_open_recl",
							/* FCR_OPEN_RECL */
     52, MTYPE_M,     104, MTYPE_M,       FID_CRAY_OPENLIST, "cray_open_blank",
							/* FCR_OPEN_BLANK */
     60, MTYPE_M,     120, MTYPE_M,       FID_CRAY_OPENLIST, "cray_open_position",
							/* FCR_OPEN_POSITION */
     68, MTYPE_M,     136, MTYPE_M,       FID_CRAY_OPENLIST, "cray_open_action",
							/* FCR_OPEN_ACTION */
     76, MTYPE_M,     152, MTYPE_M,       FID_CRAY_OPENLIST, "cray_open_delim",
							/* FCR_OPEN_DELIM */
     84, MTYPE_M,     168, MTYPE_M,       FID_CRAY_OPENLIST, "cray_open_pad",
							/* FCR_OPEN_PAD */
#ifdef ABSOFT_EXTENSIONS
     92, MTYPE_M,     184, MTYPE_M,       FID_CRAY_OPENLIST, "cray_open_convert",
							/* FCR_OPEN_CONVERT */
#if defined(TARG_X64) || defined(__APPLE__)
     100, MTYPE_M,     200, MTYPE_M,       FID_CRAY_OPENLIST, "cray_open_creator",
							/* FCR_OPEN_CREATOR */
     108, MTYPE_M,     216, MTYPE_M,       FID_CRAY_OPENLIST, "cray_open_filetype",
							/* FCR_OPEN_FILETYPE */
#define WINDOWS_BYTES_32 16
#define WINDOWS_BYTES_64 32
#else
#define WINDOWS_BYTES_32 0
#define WINDOWS_BYTES_64 0
#endif
     100+WINDOWS_BYTES_32, MTYPE_U4,   200+WINDOWS_BYTES_64, MTYPE_U8,      FID_CRAY_OPENLIST, "cray_open_blocksize",
							/* FCR_OPEN_BLOCKSIE */
     104+WINDOWS_BYTES_32, MTYPE_M,    208+WINDOWS_BYTES_64, MTYPE_M,       FID_CRAY_OPENLIST, "cray_open_carriagecontrol",
							/* FCR_OPEN_CARRIAGECONTROL */
     112+WINDOWS_BYTES_32, MTYPE_U4,   224+WINDOWS_BYTES_64, MTYPE_U8,      FID_CRAY_OPENLIST, "cray_open_maxrec",
							/* FCR_OPEN_MAXREC */
     116+WINDOWS_BYTES_32, MTYPE_U4,   232+WINDOWS_BYTES_64, MTYPE_U8,      FID_CRAY_OPENLIST, "cray_open_buffer",
							/* FCR_OPEN_BUFFER */
     120+WINDOWS_BYTES_32, MTYPE_M,    240+WINDOWS_BYTES_64, MTYPE_M,       FID_CRAY_OPENLIST, "cray_open_dispose",
							/* FCR_OPEN_DISPOSE */
     128+WINDOWS_BYTES_32, MTYPE_U4,   256+WINDOWS_BYTES_64, MTYPE_U8,      FID_CRAY_OPENLIST, "cray_open_block",
							/* FCR_OPEN_BLOCK */
#endif
   ...
   164, MTYPE_M,     320, MTYPE_M,        FID_CRAY_INQLIST,   "cray_inq_pad",
							/* FCR_INQ_PAD */
#ifdef ABSOFT_EXTENSIONS
   172, MTYPE_U4,    336, MTYPE_U8,       FID_CRAY_INQLIST,   "cray_inq_blocksize",
							/* FCR_INQ_BLOCKSIZE */
   176, MTYPE_M,     344, MTYPE_M,        FID_CRAY_INQLIST,   "cray_inq_carriagecontrol",
							/* FCR_INQ_CARRIAGECONTROL */
   184, MTYPE_U4,    360, MTYPE_U8,       FID_CRAY_INQLIST,   "cray_inq_flen",
							/* FCR_INQ_FLEN */
   188, MTYPE_U4,    368, MTYPE_U8,       FID_CRAY_INQLIST,   "cray_inq_size",
							/* FCR_INQ_SIZE */
...
#ifdef ABSOFT_EXTENSIONS
        if (items[IOC_BLOCKSIZE] != NULL)
	   Gen_Io_PutAddrWN(block, st, FCR_INQ_BLOCKSIZE, items[IOC_BLOCKSIZE]);
        if (items[IOC_CARRIAGECONTROL] != NULL)
	   Gen_Io_PutAddrWN(block, st, FCR_INQ_CARRIAGECONTROL, items[IOC_CARRIAGECONTROL]);
        if (items[IOC_FLEN] != NULL)
	   Gen_Io_PutAddrWN(block, st, FCR_INQ_FLEN, items[IOC_FLEN]);
        if (items[IOC_SIZE] != NULL)
	   Gen_Io_PutAddrWN(block, st, FCR_INQ_SIZE, items[IOC_SIZE]);
#endif
...
#ifdef ABSOFT_EXTENSIONS
        if (items[IOC_CONVERT] != NULL)
	   Gen_Io_PutAddrWN(block, st, FCR_OPEN_CONVERT, items[IOC_CONVERT]);
#if defined(TARG_X64) || defined(__APPLE__)
        if (items[IOC_CREATOR] != NULL)
	   Gen_Io_PutAddrWN(block, st, FCR_OPEN_CREATOR, items[IOC_CREATOR]);
        if (items[IOC_FILETYPE] != NULL)
	   Gen_Io_PutAddrWN(block, st, FCR_OPEN_FILETYPE, items[IOC_FILETYPE]);
#endif
        if (items[IOC_BLOCKSIZE] != NULL)
	   Gen_Io_PutAddrWN(block, st, FCR_OPEN_BLOCKSIZE, items[IOC_BLOCKSIZE]);
        if (items[IOC_CARRIAGECONTROL] != NULL)
	   Gen_Io_PutAddrWN(block, st, FCR_OPEN_CARRIAGECONTROL, items[IOC_CARRIAGECONTROL]);
        if (items[IOC_MAXREC] != NULL)
	   Gen_Io_PutAddrWN(block, st, FCR_OPEN_MAXREC, items[IOC_MAXREC]);
        if (items[IOC_BUFFER] != NULL)
	   Gen_Io_PutAddrWN(block, st, FCR_OPEN_BUFFER, items[IOC_BUFFER]);
        if (items[IOC_DISPOSE] != NULL)
	   Gen_Io_PutAddrWN(block, st, FCR_OPEN_DISPOSE, items[IOC_DISPOSE]);
        if (items[IOC_BLOCK] != NULL)
	   Gen_Io_PutAddrWN(block, st, FCR_OPEN_BLOCK, items[IOC_BLOCK]);
#endif
