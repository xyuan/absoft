...
/** $Revision: 2220 $
*** $Date: 2006-06-06 09:11:30 -0400 (Tue, 06 Jun 2006) $
*** $Author: yin $
*** $Source$
**/
...
#ifdef _KEEP_RCS_ID
static char *dep_graph_rcs_id = dep_graph_INCLUDED "$Revision: 2220 $";
#endif /* _KEEP_RCS_ID */
...
public:
  ...
  EINDEX16 Add_Edge(VINDEX16 from, VINDEX16 to, DEPV_ARRAY *array) {
    ...
    #ifdef Is_True_On
    if( !Get_Edge(from,to) ) DevWarn(("Duplicate edge in Add_Edge \n")); 
    #endif
#else
