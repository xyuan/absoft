...
#ifdef TARG_X8664 //bug 10953 -- to generate prefetch address
...
if(LNO_Run_Prefetch > SOME_PREFETCH && offset != 0 &&
   ...
   if(loop && Good_Loop_To_Adjust_Offset(loop,ref)){
     ...
     if(Is_Target_Core() || Is_Target_EM64T() || Is_Target_Wolfdale() )
       fancy_offset_incr=8;
...
#ifdef TARG_X8664 //bug 10953: temporal locality estimation may not be
