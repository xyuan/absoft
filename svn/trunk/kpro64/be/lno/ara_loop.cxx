...
{ 
  ...
  if (!LNO_Pseudo_Lower || dli->Mp_Info != NULL 
    ...
    wn_num_threads = Get_Runtime_Numthreads_Ldid_From_Func((WN*) wn_loop);
#else
...
#ifdef ABSOFT_EXTENSIONS
  if (dli->Is_Doacross) {
        // Disable Parallelization for a loop that needs synchronization
        // DOACROSS is not supported in Transform_Do function 
	return;
  }
#endif
