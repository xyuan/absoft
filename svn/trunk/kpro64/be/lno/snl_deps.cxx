...
static char *rcs_id =   snl_utils_CXX "$Revision: 2885 $";
  ...
  BOOL parallel)
{
  ...
  // this situation does happen, Too short dependence vector for SNL_DEP_INFO::Enter()
  // for example, between two arrays with different dimensions
  if( !( components >= Nloops() + First_Component() ) ) return;
#else
