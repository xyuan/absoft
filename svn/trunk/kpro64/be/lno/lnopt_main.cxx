 ...
 * Module: lnopt_main.c
 * $Revision: 2952 $
 * $Date: 2009-01-12 11:41:55 -0500 (Mon, 12 Jan 2009) $
 * $Author: yin $
 * $Source$
 *
 * Revision history:
...
static
INT64 Loop_Size(WN* wn, bool bodyonly = false)
{
...
#ifdef ABSOFT_EXTENSIONS
// do not multiply the iteration number
INT64 Loop_Body_Size(WN* wn)
{
   return Loop_Size( wn, true );
}
#endif
...
extern "C"
#endif
WN * Lnoptimizer(PU_Info* current_pu, 
