...
// Module: opt_wn.h
// $Revision: 3015 $
// $Date: 2009-05-06 12:32:00 -0400 (Wed, 06 May 2009) $
// $Author: yin $
...
#ifdef _KEEP_RCS_ID
static char *opt_wnrcs_id = 	opt_wn_INCLUDED"$Revision: 3015 $";
#endif /* _KEEP_RCS_ID */
...
enum WN_FLAG_TYPE {
  ...
  // I think 0x16 is a junk number but not touch it since we still has space so far
  WN_FLAG_PROMOTED_DO_LOOP = 0x16,   // do-loop promoted from while-do 
  WN_FLAG_PRAGMA_HAS_MU = 0x20,
  WN_FLAG_PRAGMA_HAS_CHI = 0x40,
#else
  WN_FLAG_PROMOTED_DO_LOOP = 0x16   // do-loop promoted from while-do
#endif
};
