...
// $Revision: 2748 $
// $Date: 2007-08-22 15:37:10 -0400 (Wed, 22 Aug 2007) $
// $Author: yin $
// $Source$
//
// ====================================================================
...
public:
  ...
  friend bool operator==(const self& x, const self& y) {
    ...
    Cluster_iterator c1 = x.ci;
    Cluster_iterator c2 = y.ci;
    if (x.ci == y.ci)
      return x.fi == y.fi;
    if (x.fi == (*x.ci).end()){
      int adjacent = 1;
      ...
      return y.fi == (*y.ci).begin() && adjacent;
    }
    if (x.fi == (*x.ci).begin()){
      int adjacent = 1;
      ++c1;
