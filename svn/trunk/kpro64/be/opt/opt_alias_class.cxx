...
// $Revision: 3009 $
// $Date: 2009-04-29 10:59:48 -0400 (Wed, 29 Apr 2009) $
// $Author: yin $
...
*/
  ...
  // information available to the callee.
    ...
    if( opr == OPR_MLOAD && WN_kid1(expr) ){ // For Open_MP
	Classify_deref_of_expr(WN_kid1(expr), TRUE);
    }
#endif
