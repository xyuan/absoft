...
INT32 VF_CHAR_OPTION = 0;
INT32 One_Trip_Do_Loops = 0;
INT32 Standard_Return = 0; // return structure by value
#endif
...
/* ====================================================================
 * Entry point from non-Cray compiler
 * ====================================================================
 */

#if defined(ABSOFT_EXTENSIONS)
void
PDGCS_entry_no_SGI_fe(void)
{
