 ...
 * $Revision: 2789 $
 * $Date: 2007-11-20 13:44:55 -0500 (Tue, 20 Nov 2007) $
 * $Author: yin $ 
 * $Source$
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *rcs_id = "$Source$ $Revision: 2789 $";
#endif /* _KEEP_RCS_ID */

#if defined(ABSOFT_EXTENSIONS)
extern INT32 VF_CHAR_OPTION;
extern INT32 One_Trip_Do_Loops;
extern INT32 Standard_Return;
#endif
...
extern void  PDGCS_entry_no_SGI_fe(void);
