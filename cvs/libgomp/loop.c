...
void
AOMP_loop_static_init(long start, long end, long incr, long chunk_size)
{
  struct gomp_thread *thr = gomp_thread ();
...
void
AOMP_loop_dynamic_init (long start, long end, long incr, long chunk_size)
{
  struct gomp_thread *thr = gomp_thread ();
...
void
AOMP_loop_guided_init (long start, long end, long incr, long chunk_size)
{
  struct gomp_thread *thr = gomp_thread ();
...
void
AOMP_loop_runtime_init (long start, long end, long incr)
{
  struct gomp_task_icv *icv = gomp_icv (false);
  switch (icv->run_sched_var)
    {
    case GFS_STATIC:
      return AOMP_loop_static_init (start, end, incr, icv->run_sched_modifier);
    case GFS_DYNAMIC:
      return AOMP_loop_dynamic_init (start, end, incr, icv->run_sched_modifier);
    case GFS_GUIDED:
      return AOMP_loop_guided_init (start, end, incr, icv->run_sched_modifier);
    case GFS_AUTO:
      /* For now map to schedule(static), later on we could play with feedback
	 driven choice.  */
      return AOMP_loop_static_init (start, end, incr, 0);
    default:
      abort ();
    }
}
...
void
AOMP_loop_ordered_static_init (long start, long end, long incr, long chunk_size)
{
  struct gomp_thread *thr = gomp_thread ();
...
void
AOMP_loop_ordered_dynamic_init (long start, long end, long incr, long chunk_size)
{
  struct gomp_thread *thr = gomp_thread ();
...
void
AOMP_loop_ordered_guided_init (long start, long end, long incr, long chunk_size)
{
  struct gomp_thread *thr = gomp_thread ();
...
void
AOMP_loop_ordered_runtime_init (long start, long end, long incr)
{
  struct gomp_task_icv *icv = gomp_icv (false);
  switch (icv->run_sched_var)
    {
    case GFS_STATIC:
      return AOMP_loop_ordered_static_init (start, end, incr, icv->run_sched_modifier);
    case GFS_DYNAMIC:
      return AOMP_loop_ordered_dynamic_init (start, end, incr, icv->run_sched_modifier);
    case GFS_GUIDED:
      return AOMP_loop_ordered_guided_init (start, end, incr, icv->run_sched_modifier);
    case GFS_AUTO:
      /* For now map to schedule(static), later on we could play with feedback
	 driven choice.  */
      return AOMP_loop_ordered_static_init (start, end, incr, 0);
    default:
      abort ();
    }
}
