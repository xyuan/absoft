...
{
#ifdef ABSOFT_EXTENSIONS
  /* used for copyprivate duo to minimum modification of Open64 backend */
  void* copyprivate;
#endif
...
extern void AOMP_loop_guided_init (long start, long end, long incr, long chunk_size);
extern void AOMP_loop_runtime_init (long start, long end, long incr);
extern void AOMP_loop_ordered_static_init (long start, long end, long incr, long chunk_size);
